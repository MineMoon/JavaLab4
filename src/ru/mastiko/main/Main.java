...
import ru.mastiko.mfilter.Mfilter;
import ru.mastiko.pairfiller.Pairfiller;
import ru.mastiko.userinput.Check;
import ru.mastiko.userinput.UserInput;


// нарушены правила отступов (2 пробела вместо 4), 
// отсутствуют обязательные фигурные скобки для однострочных блоков if,
// отсутствуют пробелы после ключевых слов if, switch, do, while,
// интерфейс взаимодействия реализован на русском языке,
 ...
 * Orchestrates testing of various utility classes and data structures.
 */
public class Main {

  /**
   * Main execution loop for the laboratory work.
   *
  ...
  public static void main(String[] args) {
    ...
    do {
      if (navigationChoice == 2) {
        selectedTask = input.inputChoiceInt(1, 8, "topic:\n"
            + "1. Comparable (House)\n"
            + "2. Immutable Array\n"
            + "3. Filler\n"
            + "4. Converter\n"
      ...
      switch (selectedTask) {
        case 1:
          System.out.println("=== Testing House class (Comparable) ===");
          House house1 = new House(5);
          House house2 = new House(10);
          House house3 = new House(1);
          House house4 = new House(5);
        ...
        case 2:
          System.out.println("=== Testing ImmutableListOfValues ===");
          ImmutableListOfValues<Integer> intArr = new ImmutableListOfValues<>(1, 2, 3);
          ImmutableListOfValues<Double> doubleArr = new ImmutableListOfValues<>(1.0, 2.3, 3.4);
          ImmutableListOfValues<Float> floatArr = new ImmutableListOfValues<>(1f, 2f, 3f);
          
          System.out.println("Integers: " + intArr);
          System.out.println("Doubles: " + doubleArr);
          System.out.println("Floats: " + floatArr);
          break;

        case 3:
          System.out.println("=== Testing Mfiller ===");
          List<Integer> intList = new ArrayList<>();
          Mfiller.oneHungredFiller(intList, i -> i * 2);
          System.out.println("Test 1 - Integers: " + intList.size() + " elements");
          System.out.println("First 3: " + intList.subList(0, 3));
          
          List<Double> doubleList = new ArrayList<>();
          Mfiller.oneHungredFiller(doubleList, i -> (double) i);
          System.out.println("Test 2 - Doubles: " + doubleList.size() + " elements");
          break;

        case 4:
          System.out.println("=== Testing Mconverter ===");
          System.out.println("Task 1: Strings to lengths");
          List<Integer> lengths = Mconverter.function(strings, String::length);
          System.out.println("Input: " + strings + " -> Output: " + lengths);

          System.out.println("\nTask 2: Abs values");
          List<Integer> absoluteValues = Mconverter.function(numbers, Math::abs);
          System.out.println("Input: " + numbers + " -> Output: " + absoluteValues);
          break;

        case 5:
          System.out.println("=== Testing Mfilter ===");
          List<String> filteredStrings = Mfilter.filter(strings, s -> s.length() >= 3);
          System.out.println("Length >= 3: " + filteredStrings);

          List<Integer> filteredNumbers = Mfilter.filter(numbers, n -> n <= 0);
          System.out.println("Negative only: " + filteredNumbers);
          break;

        case 6:
          System.out.println("=== Testing Contraction ===");
          String concat = Contraction.contraction(strings, (s1, s2) -> s1 + s2);
          System.out.println("Concatenation: " + concat);

          Integer sum = Contraction.contraction(numbers, Integer::sum);
          System.out.println("Sum of numbers: " + sum);
          break;

        case 7:
          System.out.println("=== Testing MCollector ===");
          System.out.println("Partitioning numbers (Positive/Negative):");
          List<List<Integer>> partitioned = MCollector.collect(numbers,
              () -> Arrays.asList(new ArrayList<>(), new ArrayList<>()),
              (lists, number) -> {
                if (number > 0) {
          ...
          System.out.println("Positive: " + partitioned.get(0));
          System.out.println("Negative: " + partitioned.get(1));
          break;

        case 8:
          System.out.println("=== Testing Pairfiller ===");
          List<Pair<Integer, Double>> pairs = new ArrayList<>();
          Pairfiller.oneHungredFiller(pairs, i -> i, i -> i * 1.0);
          System.out.println("Pairs (first 3): " + pairs.subList(0, 3));
          break;
